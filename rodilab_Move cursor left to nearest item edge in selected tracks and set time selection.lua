-- @description Move cursor left to nearest item edge in selected tracks and set time selection
-- @author Rodilab
-- @version 1.0
-- @about
--   Move cursor left to nearest item edge in selected tracks and set time selection
